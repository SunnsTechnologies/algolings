// Shared between exercises/linked-list/src/traverse.rs (the learner-facing
// skeleton) and exercises/linked-list-solutions/src/traverse.rs (the
...
mod tests {
    ...
    fn finds_an_existing_value() {
        let list = SinglyLinkedList::from_values(&[10, 20, 30]);
